...
(function (root, factory) {
    ...
    var tpl = [
        ...
        '</div>',
        '<div class="weui-flex__item" style="float:left;text-align: center;">',
        '<div style="background-color: #e3e654;height: 10px;width:10px;display:inline-block;"></div>',
        '<span>已预约</span>',
        '</div>',
        '<div class="weui-flex__item" style="float:left;text-align: center;">',
    ...
    $.extend(calendar.prototype, {
        ...
        setSelectDate: function (date, order_number) {
            ...
            if (curSltItem.length) {
                ...
                if (!curSltItem.hasClass('jr') && !curSltItem.hasClass('wk') && !curSltItem.hasClass('full') && !curSltItem.hasClass('sub')) {
