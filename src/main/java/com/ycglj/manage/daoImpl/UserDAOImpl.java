    ...
    public Integer updateUserDataAffirm(String openId, List list, Integer authen_type) {
        ...
        while (iterator.hasNext()) {
            ...
            try {
                ...
                user_License.setAgree(0);    //延续猴默认是0
                System.out.println("user_data2");

                MyTestUtil.print(user_Data2);

                if (user_Data2 != null) {
                    int ii = UpdateExe.get(this.getJdbcTemplate(), user_License);
...
//		List list=SelectExe.get(this.getJdbcTemplate(), test2);
    ...
    @Override
    public Map<String, Object> getAllTempUser(Integer limit, Integer offset, String sort, String order,
                                              Map<String, String> search, String openId, Integer area1) {
        // TODO Auto-generated method stub
