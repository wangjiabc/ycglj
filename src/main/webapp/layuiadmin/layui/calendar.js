...
(function (root, factory) {
    ...
    var tpl = [
        ...
        '<div class="cal-wrap">',
        // '<button id="setStatus" class="layui-btn">设置预约状态</button>',
        '<div class="weui-flex" style="font-size:10px;">',
        '<div class="weui-flex__item" style="float:left;text-align: center;">',
        '<div style="background-color: #ee0606;height: 10px;width:10px;display:inline-block;"></div>',
        '<span>预约人数已满</span>',
        '</div>',
        '<div class="weui-flex__item" style="float:left;text-align: center;">',
        '<div style="background-color:  #03C7AD;height: 10px;width:10px;display:inline-block;"></div>',
        '<span>选中状态</span>',
        '</div>',
        '<div class="weui-flex__item" style="float:left;text-align: center;">',
        '<div style="background-color: #cfcfcf;height: 10px;width:10px;display:inline-block;"></div>',
        '<span>不可预约</span>',
        '</div>',
        '</div>',

        '<div class="weui-flex" style="text-align:center">',
        '<div id="prevMonth" class="weui-flex__item"> <<',
        '</div>',
        '<h2 class="weui-flex__item">{%date%}</h2>',
        '<div id="nextMonth" class="weui-flex__item"> >>',
        '</div>',
        '</div>',
    ...
    var holidaysMap = [
        ...
        {
            name: '元旦',
            date: ['2018-12-30', '2018-12-31', '2019-01-01', '2019-12-31', '2020-01-01']
        },
        {
            name: '除夕',
            date: ['2018-02-15', '2019-02-04', '2020-01-2']
        },
        {
            name: '春节',
            date: ['2018-02-16', '2019-02-05', '2019-02-06', '2019-02-07', '2019-02-08', '2019-02-09', '2019-02-10', '2020-01-25']
        },
        {
            name: '元宵节',
            date: ['2018-03-02', '2019-02-19', '2020-02-18']
        },
        {
            name: '清明节',
            date: ['2018-04-05', '2019-04-07', '2019-04-05', '2019-04-06', '2020-04-04']
        },
        {
            name: '五一',
            date: ['2018-05-01', '2019-05-01', '2019-04-29', '2019-04-30', '2020-05-01']
        },
        {
            name: '端午节',
            date: ['2018-06-18', '2019-06-07', '2019-06-06', '2019-06-08', '2020-06-25']
        },
        {
            name: '中秋节',
            date: ['2018-09-24', '2019-09-13', '2019-09-14', '2019-09-15', '2020-10-01']
        },
        {
            name: '国庆节',
            date: ['2018-10-01', '2019-10-02', '2019-10-03', '2019-10-04', '2019-10-05', '2019-10-06', '2019-10-07', '2019-10-01', '2020-10-01']
        }
    ];
    var pNum = 0;
    ...
    var calendar = function (config) {
        this.defaultConfig = {
             ...
             * type {string}
             */
            // selectDateName: pNum <= 30 ? "已满" : pNum + "人",
            /**
             * 是否显示节假日
             * type {boolean}
             */
    ...
    $.extend(calendar.prototype, {
         ...
         */
        setSelectDate: function (date, order_number) {
            var me = this,
                config = this.config,
            ...
            if (lastSltItem.length) {
                ...
                if (!lastSltItem.hasClass('jr') && !lastSltItem.hasClass('wk') && !lastSltItem.hasClass('full')) {
            ...
            if (curSltItem.length) {
                ...
                // curSltItem.removeClass('jr wk ful l sub');
                curSltItem.addClass('cur');
                if (!curSltItem.hasClass('jr') && !curSltItem.hasClass('wk') && !curSltItem.hasClass('full')) {
